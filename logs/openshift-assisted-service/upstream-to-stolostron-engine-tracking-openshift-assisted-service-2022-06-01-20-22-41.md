## Fast foarding of openshift/assisted-service into stolostron-engine/tracking-openshift-assisted-service.
...
```
9cd3f42ac32efecdb80550eb4557c23494e71f9b Bug 2089337: Fix the retry function to actually retry (#3856)
f466e0ae6ac8c0955e92f95826c011cd3791bf45 NO-ISSUE: Add a retry in setup lso (#3805)
2f75e939a3b6b8259ab0b874dac0863a7db6880d Bug 2083075: Allow cluster name to start with number (#3799)
2324f6d2d002d0621ffc7e8c8919e99582d4be17 Revert "MGMT-10174: Add node ip hint manifest for sno. We want to be able to set ip for kubelet that will match machine cidr that we set for cluster. (#3780)" (#3794)
ad9443975a29214318aceec5514a3355fac50009 Bug-2083312: On validation 'non-overlapping-subnets', canonize subnets from same interfaces (#3787)
4dcf833e3547ecd3fa14e1377aa5b84ea68e32ee MGMT-10174: Add node ip hint manifest for sno. We want to be able to set ip for kubelet that will match machine cidr that we set for cluster. (#3780)
57c8e35598eb1fc0d6e07d10338bef5ffb6cea53 removing OLM operator must-gather from docs (#3777)
36ca4891470f6f05cbf94f25681e8433574ed728 Bug-2070838: Installation on baremetal SNO failed because 2 interfaces had overlapping subnets When installing host with overlapping subnets, the installation may fail. Added validation that no host has addresses that belong to overlapping networks. (#3706)
3a5444e54cac2e3520159f9b118e35817fef2d60 Bug 2081779: Implementing new service-agent protocol on server side - backport (#3756)
7d8c78b9f499eea1701c504d95ffb13cb96c4881 WIP MGMT-9726: Wait for assisted-image-service when deploying the operator (#3764)
36e13cf2ef0315479a661fd98186fc46c47748ff NO-ISSUE - Add the ability to override image-service image when deploying the assisted-image-service (#3758)
0356f7e3338d5e114309134975d75818b1bf8b7e Bug 2068301: Upon modifyin DNS entry in DHCP server - SNO OCP platform does not update resolv.conf Changing force dns script for sno , now it will recreate resolv.conf every network manager restart (#3753)
495c1c66414a18e9b4414b8783f333fb1a719fff MGMT-10164: sync generated code (#3736)
20f7a5ad28edffd2ce251d4a8381f6f60da6be7b NO-ISSUE: fix generate target (#3716)
b94f99cc24c437020ff4c02e00e2bea355e1d0a8 Bug 2073413: expose API/Ingress vips in ACI (#3670)
b3c9277e2e55b5fdd7f5c10b371057dd2662f765 Bug 2076901: `pin-latest.py` script should exclude the postgres image (#3686)
f5c5cc38fa11b8ebe14dde773593007f61f39b8d Bug 2077921: Operator deployment script doesn't wait after patching the Provisioning CR (#3701)
d06792fcfdd6d96416f94a86efe3eddee4a9f5b1 [release-ocm-2.5] Bug 2075416: ensure secret is labelled when it is being reconciled (#3668)
e5808c536271e025bca142b360965b4c3141d2e5 MGMT-9934: Use compatible iPXE script format (#3659)
8a1720a6d121b61a1053a12b960fad04df068547 Bug-2072929: agent is stuck on pending input condition when configuring the network for a multi node/compact ipv6 spoke There are cases that agent CR gets out of sync from the corresponding host database record. It happens after host database record has been updated. Although additional reconcile is expected at this point, there are cases that the update result is not reflected in the CR. In order to avoid such case, the returned value from the host update is taken and used to update the agent status. (#3662)
e15861d5649d9481debe64184650ad52e6e4fe42 Bug 2073814: Assisted service POD is evicted when installing large multi-node cluster (#3641)
8eaf1b4d09734cfc644e1a2be2b25ddab32374b0 Bug 2030480: Handle incorrect rootDeviceHints instead of ignoring (#3625)
601f2fdd27cb64d7c4a1731ad5e4ff88959961a3 Bug 2069101: fail sno deployment with SDN (#3628)
73685abfff438c08656281f719b1a59447c57645 Bug-2061317: when using nmstateconfigs ISO is re-generated for each nmstateconfig When updating infra-env, static network configuration is saved if it is present in the update parameters and if it is different from the previous value already in the database. Updating infra-env causes download URL regeneration which is undesirable. Since this configuration is a slice of elements, that each of them contains a slice, changing the order of items in any of the slices, may cause the static network configuration to be different than the previous value, but equivalent in terms of configuration when applied. To prevent this, sort was added to verify that equivalent configurations will generate same string value to be stored in the database. (#3626)
7a4ed93eb611ad51a1dafcaf9ac93b280804a611 BUG-2063814: Set progress_total_percentage 100% alongside cluster status installed (#3624)
e3277597298022de2f45220a2adc19e2e4cc2b0f MGMTBUGSM-216: improve ClusterImageSet sync error message (#3602)
4115ba87ce85c980ac24b5c006ce1cc1edf1d52b Bug 2065034: Correct ignition validation message for day 2 host (#3601)
7423a5683259760adc8727795dae3761e9202686 Bug 2069974: Host status change to insufficient when binding a host to a cluster (#3596)
f8ef61f3580dd2dd0545d0d64826740091df6881 [release-ocm-2.5] Bug 2068365: ensure secrets have backup labels (#3557)
989352ca9a919b36e18dd78d0d10e7a85b700fc7 Bug 2055333: gc api server when controller is done (#3551)
c5de75432e79f5422706a02a111a8e5939fd7018 Bug 2065288: Add support for Ignition overrides for day2 worker (#3544)
d1ae96619b3c797794d7a350ad50401ad988ed51 Bug 2066786: Set the correct stopping state for a day2 cluster. Presently when setting a cluster to become "Day 2", the Stopped condition is incorrectly configured with default values that do not make sense. (#3536)
d4e752465bf7c63ee18e8e15753f1f4bfb4f94ac [release-ocm-2.5] Bug 2067086: Set boot artifact URLs in infra-env (#3534)
6bbd8ff15c9029bf207152dab9c8e00208773e5b [release-ocm-2.5] Bug 2066649: Stop BMH reconcile if InfraEnv label is missing (#3529)
104cd1e37252d4bfb52c518440d1fb6e412acb14 Bug 2065661: `pin-latest.py` should allow a custom tag to be set (#3509)
899ab331dcc1e0bbac7f6142124007e56e7f4020 Bug 2065649: Fix image tags in operator's CSV (#3506)
7e4f6a2abdff6c368464d36cae42e98ffff7d0a1 NO-ISSUE: optimize build image size (#3515)
bf8fcab0e181bc8e9554846c86be30a17d6d4561 MGMTBUGSM-181: ipv6 spoke cluster installation would fail when unchecking 'use advanced network', due to ipv4 defaults cidrs To avoid cases that cluster installation fails due to network address families of (MachineNetworks, ServiceNetworks, ClusterNetworks) not the same, a new cluster validation is added. The validation compares the address families and return failure if not the same. In case machine networks are not required (user-managed-networking), only service and cluster networks are compared. (#3511)
25546b98632214dafd8a5885a501fbc74be982ad MGMTBUGSM-191: Race between agent and clusterDeployment reconciler causes day2 host installation to ignore requested hostname (#3489)
c0c4d15bd32fac63c48e30908516d7cf92109b46 MGMT-9528: refactor code-generation scripts (#3490)
df53f0d41eed8b02e601c5c274ef0c7c4b97be27 MGMT-9539: Add presigned iPXE script URL endpoint (#3460)
cb48591dee6f39382362922d6354743574b7454b MGMT-9566: Improve UpdateInstallProgress performance calculating cluster progress (#3464)
